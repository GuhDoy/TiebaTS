...
public class OriginSrc extends BaseHooker implements Hooker {
    ...
    public void hook() throws Throwable {
        ...
        ConnectivityManager connMgr = (ConnectivityManager) sContextRef.get().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private class NetworkCallbackImpl extends ConnectivityManager.NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            ...
            if (networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED) && networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI)) {
                ...
                XposedHelpers.findAndHookMethod("tbclient.PbContent$Builder", mClassLoader, "build", boolean.class, new XC_MethodHook() {
                    @Override
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                XposedHelpers.findAndHookMethod("tbclient.Media$Builder", mClassLoader, "build", boolean.class, new XC_MethodHook() {
                    @Override
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        XposedHelpers.setObjectField(param.thisObject, "show_original_btn", 0);
