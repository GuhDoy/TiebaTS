...
public class HomeRecommend extends BaseHooker implements IHooker {
    public void hook() throws Throwable {
        ...
        if (Preferences.getBoolean("purify_enter")) {
            ...
            XposedHelpers.findAndHookMethod("com.baidu.tieba.flutter.base.view.FlutterEnterForumDelegateStatic", sClassLoader, "createFragmentTabStructure", new XC_MethodHook() {
                @Override
                protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                    try {
                        XposedHelpers.setIntField(param.getResult(), "type", 2);
