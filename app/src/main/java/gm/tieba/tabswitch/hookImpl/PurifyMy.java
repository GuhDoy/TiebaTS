...
public class PurifyMy extends Hook {
    public static void hook(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedHelpers.findAndHookMethod("com.baidu.tieba.flutter.view.FlutterDelegateStatic", lpparam.classLoader, "createFragmentTabStructure", XC_MethodReplacement.returnConstant(null));
        for (int i = 0; i < ruleMapList.size(); i++) {
            ...
            switch (Objects.requireNonNull(map.get("rule"))) {
                case "Lcom/baidu/tieba/R$drawable;->icon_pure_topbar_store44_svg:I"://商店
                    XposedHelpers.findAndHookMethod(map.get("class"), lpparam.classLoader, map.get("method"), int.class, new XC_MethodHook() {
                ...
                case "Lcom/baidu/tieba/R$id;->function_item_bottom_divider:I"://分割线
                    Method[] dividers = lpparam.classLoader.loadClass(map.get("class")).getDeclaredMethods();
                ...
                case "\"https://tieba.baidu.com/mo/q/duxiaoman/index?noshare=1\""://我的ArrayList
                    Method[] myArrayLists = lpparam.classLoader.loadClass(map.get("class")).getDeclaredMethods();
