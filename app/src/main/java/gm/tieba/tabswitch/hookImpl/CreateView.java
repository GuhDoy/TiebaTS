            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                for (int i = 0; i < ruleMapList.size(); i++) {
                    ...
                    if (Objects.equals(map.get("rule"), "Lcom/baidu/tieba/R$id;->navigationBarGoSignall:I"))
                        XposedHelpers.findAndHookMethod(map.get("class"), lpparam.classLoader, map.get("method"), Bundle.class, new XC_MethodHook() {
                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                ...
                                for (Field field : fields) {
                                    ...
                                    if (field.get(param.thisObject) instanceof ImageView) {
                                        ...
                                        historyDrawable.setImageResource(lpparam.classLoader.loadClass("com.baidu.tieba.R$drawable").getField("icon_mask_wo_list_history24_svg").getInt(null));
                                        ...
                                        historyButton.setOnClickListener(view -> {
                                            ...
                                            intent.setClassName(activity, "com.baidu.tieba.myCollection.history.PbHistoryActivity");
                                            activity.startActivity(intent);
                                        });
                                        //collectButton
                                        final ImageView collectDrawable = new ImageView(activity);
                                        collectDrawable.setImageResource(lpparam.classLoader.loadClass("com.baidu.tieba.R$drawable").getField("icon_mask_wo_list_collect24_svg").getInt(null));
